      ...
      try {
        ...
        if (
          ...
          if (defaultContents !== undefined) {
            ...
            // Close explicitly: dropping the GFileOutputStream holds the fd until
            // GJS collects the wrapper. Every other write path here uses
            // replace_contents(), which closes for itself.
            createdStream.close(null);
            return customSettingFile;
          }
        }
      } catch (e) {
